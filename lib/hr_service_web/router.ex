defmodule HrServiceWeb.Router do
  use HrServiceWeb, :router
  ...
  if Application.compile_env(:hr_service, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HrServiceWeb.Telemetry
